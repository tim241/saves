SetPrivateProfileString('Graphics','version','OpenGL version 4.6.0 NVIDIA 410.73 - build 396')
...
SetPrivateProfileString('Graphics','renderer','GeForce GTX 1050/PCIe/SSE2')
...
SetPrivateProfileString('Game Options','Mouse Scroll Speed','41')
...
SetPrivateProfileString('Game Options','Keyboard Scroll Speed','41')
SetPrivateProfileString('Game Options','Pausing Map','0')
SetPrivateProfileString('Game Options','Render Explored Map','0')
SetPrivateProfileString('Game Options','Message Box Top','-13')
...
SetPrivateProfileString('Game Options','Last Save','000000001-Quick-Save-4')
